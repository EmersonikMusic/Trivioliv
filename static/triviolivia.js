...
const mainGameFunction = async () => {
    ...
    for (let i = 0; i < number_of_questions; i++) {
        ...
        while (questionTimeRemaining > 0) {
            ...
            document.getElementById("demo").innerHTML = i + globalData[i].category_name.toUpperCase() + ' - ' + globalData[i].difficulty_name.toUpperCase() + ' - Mark Mazurek - ' + question_seconds + '.' + question_tenths + 's';
        ...
        while (answerTimeRemaining > 0) {
            ...
            document.getElementById("demo").innerHTML = i + globalData[i].category_name.toUpperCase() + ' - ' + globalData[i].difficulty_name.toUpperCase() + ' - Mark Mazurek - ' + answer_seconds + '.' + answer_tenths + 's';
