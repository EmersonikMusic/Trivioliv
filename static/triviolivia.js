...
const yourFunctionNew = async () => {
    ...
    for (let i = 0; i < 10; i++) {
        ...
        document.getElementById("demo").innerHTML = 'Category: ' + globalData[i].category_name + ' - Subcategory: ' + globalData[i].sub_name +' -  Difficulty: ' + globalData[i].difficulty_name + ' - Author: Mark Mazurek';
