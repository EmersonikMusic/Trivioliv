...
function toggle_categories(clicked_id) {
    if (!category_list.includes(clicked_id)) {
        ...
        categoryButtons[String(clicked_id+1)].classList.remove('active');
        categoryButtons[String(clicked_id+1)].classList.add('inactive');
        ...
        categoryButtons[String(clicked_id+1)].classList.remove('inactive');
        categoryButtons[String(clicked_id+1)].classList.add('active');
        console.log(category_list);
    }
}
