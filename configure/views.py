...
def export_to_csv(request):
    ...
    question_fields = questions.values_list('text','response','answer','score','difficulty__name','category__name','subcategory__name', 'tags','author__username','date_created','active')
